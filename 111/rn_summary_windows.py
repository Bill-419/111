...
class RN_summary_Window(QWidget):
    def __init__(self):
        ...
        self.splitter_horizontal = QSplitter(Qt.Horizontal, self)
        main_layout.addWidget(self.splitter_horizontal)
        ...
        self.splitter_vertical = QSplitter(Qt.Vertical, self)
        ...
        self.splitter_vertical.addWidget(table_widget)
        ...
        self.splitter_vertical.addWidget(scroll_area)

        # 设置初始大小比例
        self.splitter_vertical.setSizes([600, 200])

        left_layout.addWidget(self.splitter_vertical)
        self.splitter_horizontal.addWidget(left_widget)

        # 右侧部分
        self.html_tab_widget = HtmlTabWidget()
        self.splitter_horizontal.addWidget(self.html_tab_widget)
